...
```
    ...
    ## 2024-10-09 15:39:59 URL:https://zenodo.org/records/13908795/files/wgbs_input.tar.gz?download=1 [1623785353/1623785353] -> "wgbs_input.tar.gz" [1]
    ## 2024-10-09 15:41:09 URL:https://labshare.cshl.edu/shares/schatzlab/www-data/pansol/Physalis/grisea/v1.3.2/Phygri1.3.2_gene_models.gff.gz [7580565/7580565] -> "annotation/Phygri1.3.2_gene_models.gff.gz" [1]
...
```
    ...
    ## [1] 0.945905073 0.019495747 0.014566582 0.011846119 0.008186479
...
![](figures/wgbs-SupFig9A_CHG-1.png)<!-- -->
...
```
    ...
    ## [1] 0.68829137 0.11093412 0.09969748 0.05955281 0.04152421
...
![](figures/wgbs-SupFig9A_CHH-1.png)<!-- --> \### CG
...
```
    ...
    ## [1] 0.87896585 0.04002774 0.03530151 0.02374003 0.02196487
...
![](figures/wgbs-SupFig9A_CG-1.png)<!-- -->
